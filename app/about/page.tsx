      ...
      <section className="bg-primary text-primary-foreground py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl opacity-90 max-w-2xl">
            Empowering informed citizens through quality journalism, independent
            reporting, and deep analysis of the stories that shape our world.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-4">
                At NewsHub, we believe in the power of journalism to inform,
                inspire, and hold power to account. We're committed to
                delivering news that matters with clarity, accuracy, and depth.
              </p>
              <p className="text-lg text-muted-foreground">
                Every story we publish is backed by rigorous research, ethical
                reporting standards, and a commitment to the truth.
              </p>
            </div>
            <div>
